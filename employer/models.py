...
class Employeer(models.Model):
    user=models.ForeignKey(CustomUser,on_delete=models.CASCADE, related_name="employeer")
...
class AssociatedEmployees(models.Model):
    employeer = models.ForeignKey(Employeer, on_delete=models.CASCADE, related_name="associated_employees")
...
class BankDetails(models.Model):
    associated_employeer = models.ForeignKey(AssociatedEmployees, on_delete=models.CASCADE, related_name="associated_bank_details")
